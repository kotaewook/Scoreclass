...
<section class="sec_talk" style="padding:0 20px 20px; margin-top:0;">
	<div class="talk_pop talk_list">
		...
		<ul>
			...
			<li>
				...
				<div class="troom_tit">
					<a href="/chat/view/<?=$list['ch_id']?>"><h4><?=$list['ch_subject']?></h4><p>&lt<?=$list['mb_nick']?>&gt <span>승률 : 55%</span></p></a>
