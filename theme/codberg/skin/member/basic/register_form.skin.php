...
<?php }  ?>
   <div id="fregister">
    ...
    <section id="fregister_term">
        <h2></i> 회원가입약관</h2>
        <div class="readonly"><?php echo $config['cf_stipulation']; ?></div>
 ...
 <div id="register_form"  class="form_01">   
    ...
    <div class="tbl_frm01 tbl_wrap" style="margin-bottom:50px;">
        <h2>개인정보 입력</h2>
        ...
        <ul>
            ...
            <li>
                ...
                <input type="email" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input email half_input required" size="70" maxlength="100" placeholder="E-mail">
	...
	<div class="tbl_frm01 tbl_wrap" style="margin-bottom:50px;">
		...
		<ul>
			<li>
				<label for="">추천인 아이디<!--strong class="sound_only">필수</strong--></label>
		        <input type="text" name="" value="" id="" <?php echo $readonly ?> class="frm_input half_input <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="추천인 아이디">
			</li>
		</ul>
	</div>

    <div class="tbl_frm01 tbl_wrap" style="margin-bottom:0;">
        <h2>기타 개인설정</h2>
        <ul>
...
<div class="btn_confirm" style="padding:40px 0;">
    <a href="<?php echo G5_URL ?>" class="btn_cancel">취소</a> &nbsp
