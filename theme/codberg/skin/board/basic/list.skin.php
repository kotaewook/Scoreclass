...
<!-- 게시판 목록 시작 { -->
<div id="brd_wrap" style="width:<?php echo $width; ?>">
    ...
    <!-- } 게시판 카테고리 끝 -->
	<!-- 게시판 검색 시작 { -->
    <fieldset id="brd_sch"<?php if (!$is_category) echo ' style="border-top:1px solid #d1d1d1 !important;"'; ?>>
    ...
    <div class="brd_list_wrap brd_list_wrap">
        ...
        <tr>
            ...
            <th scope="col">제목</th>
            <th scope="col">글쓴이</th>
            <th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회수 <i class="fa fa-sort" aria-hidden="true"></i></a></th>
            ...
            <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일  <i class="fa fa-sort" aria-hidden="true"></i></a></th>
        </tr>
        </thead>
        <tbody>
        <?php
