...
<section id="bo_w">
			...
			<td>
				<div class="bo_w_tit write_div">
					...
					<div id="autosave_wrapper">
						...
						<button type="button" id="btn_autosave" >임시 저장된 글 (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
						<div id="autosave_pop">
    ...
    <div class="write_div editor_wrap">
    ...
    <div class="btn_confirm write_div text-right" style="padding:0 10px 10px;">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn btn_submit">취소</a> &nbsp
