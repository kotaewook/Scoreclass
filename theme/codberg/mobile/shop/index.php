...
<div class="shop_warp">
	<div class="my_coin">
	<p><?=lang('<strong>보유중 코인</strong>')?><b><?=round_down_format($member['mb_cp']??0, 2)?></b><span>구입하신 코인은 마켓에서 사용하실 수 있습니다.</span></p>
	</div>
	<form action="/item/bbs/charging_ok.php" method="post">
		<div id="cash_list">
			...
			<ul>
				...
				<li>
					...
					<label for="cash"><input type="number" name="self_pt" value="0"></label>
					<?=lang('원', 'won')?>
		...
		<div id="agree">
			<p><b>결제 안내</b></p>
			<div>
				<p>결제하실 금액은 <font>3,000</font>원이며<br>총 <font>3,000</font>코인이 충전됩니다.</p>
		...
		<div class="text-center">
			<p style="padding:0 20px;"><input type="checkbox" value="1" name="agree_chk" id="agree_chk"><label for="agree_chk">가격, 유의 사항 등을 확인하였으며 구매에 동의합니다.</label></p>
