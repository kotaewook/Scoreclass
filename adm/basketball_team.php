...
$sql_common = " from {$g5['basketball_teams']} ";
...
$sql = "select count(cnt) as cnt from (select count(*) as cnt from {$g5['basketball_teams']} group by idx) as a";
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
<div class="local_ov01 local_ov">
    <span class="btn_ov01"><span class="ov_txt">전체 등록된 농구 팀 내역 </span><span class="ov_num"> <?php echo number_format($total_count) ?>건 </span></span>
</div>
...
<form name="fpointlist" id="fpointlist" method="post" action="./basketball_team_list_delete.php" onsubmit="return fpointlist_submit(this);">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td class="td_num"><?=league_name(2,$row['lg_id'])?></td>
		...
		<td headers="mb_list_mng" class="td_mng td_mng_s"><a href="./basketball_team_form.php?<?=$qstr?>&amp;w=u&amp;idx=<?=$row['idx']?>" class="btn btn_03">수정</a></td>
    </tr>
...
<div class="btn_fixed_top">
    ...
    <a href="./basketball_team_form.php" id="member_add" class="btn btn_01">팀추가</a>
    <?php } ?>
</div>
