...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="me_name">한국어<strong class="sound_only"> 필수</strong></label></th>
        <td><input type="text" name="me_ko_name" id="me_ko_name" required class="frm_input required"></td>
    </tr>
	<tr>
        <th scope="row"><label for="me_name">영어<strong class="sound_only"> 필수</strong></label></th>
        <td><input type="text" name="me_en_name" id="me_en_name" required class="frm_input required"></td>
    </tr>
	<tr>
        <th scope="row"><label for="me_name">일본어<strong class="sound_only"> 필수</strong></label></th>
        <td><input type="text" name="me_ja_name" id="me_ja_name" required class="frm_input required"></td>
    </tr>
	<tr>
        <th scope="row"><label for="me_name">중국어<strong class="sound_only"> 필수</strong></label></th>
        <td><input type="text" name="me_ch_name" id="me_ch_name" required class="frm_input required"></td>
    </tr>
    <tr>
