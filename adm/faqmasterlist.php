...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_l">
            <a href="./faqlist.php?fm_id=<?php echo $row['fm_id']; ?>" class="btn btn_01"><span class="sound_only"><?php echo stripslashes($row['fm_subject']); ?> </span>관리</a>
            <a href="/faq?fm_id=<?=$row['fm_id']?>" class="btn btn_02"><span class="sound_only"><?php echo stripslashes($row['fm_subject']); ?> </span>목록</a>
        </td>
    </tr>
    <?php
    }
