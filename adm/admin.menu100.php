<?php
$menu['menu100'] = array (
    array('100000', '운영설정', G5_ADMIN_URL.'/shop_admin/bannerlist.php',   'config'),
	array('100100', '배너관리', G5_ADMIN_URL.'/shop_admin/bannerlist.php', 'scf_banner', 1),
	array('100110', '팝업관리', G5_ADMIN_URL.'/newwinlist.php', 'scf_poplayer'),
	array('100120', '회원등급 관리', G5_ADMIN_URL.'/ranklist.php', 'cf_rank'),
	array('100130', '각종 포인트 설정', G5_ADMIN_URL.'/pointlist.php', 'cf_point'),
