...
$menu['menu400'] = array (
    array('400000', '마켓 관리', G5_ADMIN_URL.'/shop_admin/', 'shop_config'),
    array('400100', '마켓 설정', G5_ADMIN_URL.'/shop_admin/configform.php', 'scf_config'),
    array('400400', '구매내역', G5_ADMIN_URL.'/shop_admin/orderlist.php', 'scf_order', 1),
...
//    array('400200', '분류관리', G5_ADMIN_URL.'/shop_admin/categorylist.php', 'scf_cate'),
    array('400300', '상품관리', G5_ADMIN_URL.'/shop_admin/item_list.php', 'scf_item'),
