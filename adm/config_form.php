...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="3"><?php echo editor_html('cf_stipulation', get_text($config['cf_stipulation'], 0)); ?></td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_privacy">개인정보처리방침</label></th>
            <td colspan="3"><?php echo editor_html('cf_privacy', get_text($config['cf_privacy'], 0)); ?></td>
        </tr>
        </tbody>
        </table>
    </div>
