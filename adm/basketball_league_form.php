...
if ($w == "u"){
    $html_title .= " 수정";
    $sql = " select * from {$g5['basketball_leagues']} where lg_id = '$lg_id' ";
    $row = sql_fetch($sql);
...
<form name="frmnewwin" action="./basketball_league_form_update.php" onsubmit="return frmnewwin_check(this);" method="post">
	...
	<tr>
        ...
        <td>
            <table width="100%">
				...
				<?php
				$rs = sql_query("select * from {$g5['basketball_teams']} where lg_id = '{$row['lg_id']}' group by tm_id order by tm_point desc");
...
<div class="btn_fixed_top">
    <a href="./basketball_league.php?<?=$qstr?>" class=" btn btn_02">목록</a>
