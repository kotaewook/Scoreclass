...
$(function() {
    ...
    $(document).on("click", "#add_manual", function() {
        var me_ko_name = $.trim($("#me_ko_name").val());
		var me_en_name = $.trim($("#me_en_name").val());
		var me_ja_name = $.trim($("#me_ja_name").val());
		var me_ch_name = $.trim($("#me_ch_name").val());
        var me_link = $.trim($("#me_link").val());

        add_menu_list(me_ko_name, me_en_name, me_ja_name, me_ch_name, me_link, "<?php echo $code; ?>");
    });
    ...
    $(document).on("click", ".add_select", function() {
        ...
        add_menu_list(me_name, me_name, me_name, me_name, me_link, "<?php echo $code; ?>");
    });
});

function add_menu_list(ko_name, en_name, ja_name, ch_name, link, code)
{
    ...
    list += "<input type=\"text\" name=\"me_ko_name[]\" value=\""+ko_name+"\" id=\"me_ko_name_"+ms+"\" required class=\"required frm_input full_input\">";
    list += "</td>";
	list += "<td"+sub_menu_class+">";
    list += "<label for=\"me_name_"+ms+"\"  class=\"sound_only\">메뉴<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_en_name[]\" value=\""+en_name+"\" id=\"me_name_"+ms+"\" required class=\"required frm_input full_input\">";
    list += "</td>";
	list += "<td"+sub_menu_class+">";
    list += "<label for=\"me_name_"+ms+"\"  class=\"sound_only\">메뉴<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_ja_name[]\" value=\""+ja_name+"\" id=\"me_name_"+ms+"\" required class=\"required frm_input full_input\">";
    list += "</td>";
	list += "<td"+sub_menu_class+">";
    list += "<label for=\"me_name_"+ms+"\"  class=\"sound_only\">메뉴<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_ch_name[]\" value=\""+ch_name+"\" id=\"me_name_"+ms+"\" required class=\"required frm_input full_input\">";
    list += "</td>";
    list += "<td>";
